...
public class AssetLifecycleEventServiceImpl implements AssetLifecycleEventService {
    ...
    public AssetLifecycleEvent logEvent(Long assetId, AssetLifecycleEvent event) {
        ...
        if (event.getEventType() == null || event.getEventDescription() == null || event.getEventDescription().isEmpty()) {
            throw new BadRequestException("Event type and Description are required");
        }
